...
const CHECKLIST_FAQS = [
  {
    ...
    answer: 'Simple mode converts any flat list into a checklist instantly — great for quick task lists. Advanced mode supports up to 3 levels of nesting (parent → child → sub-task), with collapse/expand, per-parent progress tracking, and drag-and-drop reordering within each level.',
  },
  {
    question: 'How does the smart checklist tool work?',
    answer: 'Paste any text and the tool converts it into an interactive checklist. In Simple mode it splits by newlines, commas, or tabs. In Advanced mode, indent with 2 spaces per level to create nested items. Check off items, mark them invalid, reorder with drag-and-drop, and export when done.',
  },
  {
    question: 'How do I create nested tasks in Advanced mode?',
    answer: 'Paste indented text using 2 spaces per level (e.g. "  child task" under a parent), or start with a blank list and use the indent button (→) to move items deeper. You can nest up to 3 levels: parent, child, and sub-task. Use the outdent button (←) to promote items back up.',
  },
  {
    question: 'Is my checklist data saved?',
    answer: "Yes — checklists are automatically saved to your browser's local storage (IndexedDB). No data is sent to any server. Everything stays on your device. You can access all saved checklists from the My Checklists page.",
  },
  {
    question: 'Can I share my checklist with others?',
    answer: 'Yes. The Share button generates a URL that encodes your entire checklist (and the active mode) so anyone opening the link sees the same list in the same mode — no account or backend needed.',
  },
  {
    question: 'Can I export my checklist as a PDF?',
    answer: 'Yes. Both Simple and Advanced modes support PDF export. The Advanced PDF preserves the hierarchy with indentation per nesting level and colour-coded checkboxes (green = done, red = invalid).',
  },
  {
    question: 'What export formats are available?',
    answer: 'Simple mode: PDF, Markdown, Plain Text, CSV. Advanced mode: PDF, Markdown, Plain Text, JSON (full tree structure), CSV.',
  },
  {
    question: 'What input formats are supported in Simple mode?',
    answer: 'Newlines, commas, and tabs as separators. Auto-detects existing checkbox markers like [ ], [x], ✓, and ✗ — no reformatting needed.',
  },
]
...
export function ChecklistAboutSection() {
  return (
      ...
      <div className="container py-10 md:py-12">
        <div className="mb-10">
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4 mb-8">
            {ABOUT_FEATURES.map(({ icon: Icon, label, body }) => (
        ...
        <div className="flex gap-8">
          <div className="flex-1 min-w-0">
            <FAQSection faqs={CHECKLIST_FAQS} />
          </div>
