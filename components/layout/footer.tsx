      ...
      <div className="container py-10 md:py-12">
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-6">
          ...
          <div className="flex flex-col items-center justify-center text-center shrink-0 md:w-44">
            ...
            {/* DailyPlanly promo*/ }
            <Link href="https://dailyplanly.com" target="_blank" rel="noopener noreferrer" className="inline-flex items-center mt-10 font-semibold mb-3 hover:opacity-80 transition-opacity">
